...
export const CURRENT_APP_VERSION: AppVersionInfo = {
  version: '1.6.2',
  buildTime: '2026-09-03T18:12:00Z',
  title: 'Novità della Versione 1.6.2',
  descrizioneGenerale: 'Separazione della personalizzazione in due sezioni distinte: Stemma Intestazione interna e Icona Principale App (PWA/Home).',
  novita: [
    {
